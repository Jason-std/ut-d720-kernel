...
static int b_spk_high_enable = true;
...
0x0138, 0x000b, 0x0032, 0x001f, /* 0x20...0x23 */
0x0018, 0x000c, 0x0093, 0x00e9, /* 0x24...0x27 */
0x0000, 0x000f, 0x0000, 0x0000, /* 0x28...0x2b */
0x0033, 0x0090, 0x0090, 0x0177, /* 0x2c...0x2f */
0x0177, 0x000f, 0x01e1, 0x01e1, /* 0x30...0x33 */
0x0035, 0x0035, 0x0039, 0x0039, /* 0x34...0x37 */
0x0001, 0x0001, 		/* 0x38...0x3b */
...
//static unsigned  int DOCK_KEYBOARD_FLAG = 0;
//extern int hdmi_plug_flag;
//extern int g_amplifier_type;
//int earphone_inset_flag=0;
//int DOCK_KEYBOARD_FLAG=0;
//static unsigned  int DOCK_KEYBOARD_FLAG = 0;
//extern int hdmi_plug_flag=0;
extern int hdmi_plug_flag;
extern int g_amplifier_type;
...
{
	printk("%s,earphone_inset_flag:%d,DOCK_KEYBOARD_FLAG:%d",__FUNCTION__,earphone_inset_flag,DOCK_KEYBOARD_FLAG);
				      ...
				      const struct i2c_device_id *id)
{
	...
	if(!strcmp(g_selected_utmodel,"s702") 
		...
		|| !strcmp(g_selected_utmodel,"d108") //add by orange@2014/5/29
		|| !strcmp(g_selected_utmodel,"d721")) //add by Leslie Xiao 2014-6-17 14:02:41
	{
