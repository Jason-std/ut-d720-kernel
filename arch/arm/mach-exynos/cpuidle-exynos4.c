...
/* modified by Albert_lee 2014-05-15 begin */
#if defined(CONFIG_S3C_DEV_HSMMC1)
	{.base = 0, .pdev = &s3c_device_hsmmc1, .type = HC_SDHC},
#endif
 /*Albert_lee 2014-05-15 end*/
				    ...
				    struct cpuidle_state *state)
{
	...
	if (!soc_is_exynos4210()) {
		...
		exynos4x12_set_abb_member(ABB_ARM, /*ABB_MODE_085V*/ABB_MODE_075V);
	}
				   ...
				   struct cpuidle_state *state)
{
	...
	if (!soc_is_exynos4210()) {
		abb_val = exynos4x12_get_abb_member(ABB_ARM);
/* modified by Albert_lee 2014-04-23 begin */
...
early_wakeup:
	...
	if ((exynos_result_of_asv > 1) && !soc_is_exynos4210()) {
		exynos4x12_set_abb_member(ABB_ARM, abb_val);
/* added by Albert_lee 2014-04-23 begin */
...
/* added by Albert_lee 2014-05-15 begin */
#if defined(CONFIG_S3C_DEV_HSMMC1)
	if (!is_double_inand) { // TODO  if != 816 mach
		sdmmc_dev_num -=1;
	}
#endif
 /*Albert_lee 2014-05-15 end*/
