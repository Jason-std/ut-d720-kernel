...
//	{ EXYNOS4_GPK1(2),  S3C_GPIO_SLP_INPUT,	S3C_GPIO_PULL_DOWN},	//NC
	{ EXYNOS4_GPK1(2),  S3C_GPIO_SLP_OUT0,	S3C_GPIO_PULL_NONE},	//NC
...
//	{ EXYNOS4212_GPM2(0),  S3C_GPIO_SLP_OUT1,	S3C_GPIO_PULL_NONE},  // disable lcd 1.8v
	{ EXYNOS4212_GPM2(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},  // disable lcd 1.8v

	{EXYNOS4212_GPM1(5), S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},    // 3G
	{EXYNOS4212_GPM3(5), S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN},   // 3G
	{EXYNOS4212_GPM3(6), S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_DOWN},   // 3G
...
static unsigned int d720_v4_sleep_gpio_table[][3] = {
	{ EXYNOS4_GPK1(2),  S3C_GPIO_SLP_OUT1,	S3C_GPIO_PULL_NONE},	//5v EN
	{ EXYNOS4212_GPM2(0),  S3C_GPIO_SLP_PREV,	S3C_GPIO_PULL_NONE},  // disable lcd 1.8v
...
static unsigned int d521_sleep_gpio_table[][3] = {
	{ EXYNOS4_GPK1(1),  S3C_GPIO_SLP_OUT1,	S3C_GPIO_PULL_NONE},	//5v_en
};
...
//	int index = min(ARRAY_SIZE(m0_sleep_table), system_rev + 1);
	...
	}else if(CHECK_TABLET("d720","4")){
		config_sleep_gpio_table(ARRAY_SIZE(d720_v4_sleep_gpio_table),d720_v4_sleep_gpio_table);
	}else if(CHECK_UTMODEL("d721")){
		config_sleep_gpio_table(ARRAY_SIZE(d721_sleep_gpio_table),d721_sleep_gpio_table);
	}else if(CHECK_UTMODEL("d521")){
		config_sleep_gpio_table(ARRAY_SIZE(d521_sleep_gpio_table),d521_sleep_gpio_table);
	}
