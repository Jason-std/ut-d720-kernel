...
#if defined(CONFIG_FB_S5P_WA101S) || defined(CONFIG_FB_S5P_LTE480WV) || defined(CONFIG_FB_S5P_UT_LCD)
...
#if defined(CONFIG_FB_S5P_WA101S) || defined(CONFIG_FB_S5P_UT_LCD)
