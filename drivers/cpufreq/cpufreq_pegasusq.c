...
#endif
#define EARLYSUSPEND_HOTPLUGLOCK 1 /*test*/
				...
				unsigned int event)
{
	...
	#if (defined( CONFIG_EXYNOS4X12_1600MHZ_SUPPORT) ||defined( CONFIG_EXYNOS4X12_1500MHZ_SUPPORT))
	...
	policy->max=1400000;	// add by albert 
	
	if(!strncmp(g_selected_utmodel, "d816", strlen("d816"))) {
//		policy->max=1200000;	// add by albert 
	}
...
//add by jerry	
	if(!strncmp(g_selected_utmodel, "s702", strlen("s702"))
		...
		policy->max=1400000;	// add by jerry
//add end
