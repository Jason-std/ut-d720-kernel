...
//#undef MMA7660_CHANNEL_X		
//#undef MMA7660_CHANNEL_Y		
//#undef MMA7660_CHANNEL_Z		
//#undef MMA7660_DIR_X		
//#undef MMA7660_DIR_Y		
//#undef MMA7660_DIR_Z			


static int MMA7660_CHANNEL_X = 1;
static int MMA7660_CHANNEL_Y = 0;
static int MMA7660_CHANNEL_Z = 2;
static signed int MMA7660_DIR_X = -1;
static signed int MMA7660_DIR_Y = 1;
static signed int MMA7660_DIR_Z = -1;
...
static void check_sensors_model(void)
{
	s_ts_model = 712; 

	if(strncmp(g_selected_utmodel, "s702", strlen("s702")) == 0)
	{
		printk("g_selected_utmodel s702_+_+_+\n");
		MMA7660_DIR_X = -1;
		MMA7660_DIR_Y = -1;
		MMA7660_DIR_Z = -1;
		s_ut_model = 702;
	...
	{
		printk("g_selected_utmodel s501_+_+_+\n");
		MMA7660_DIR_X = 1;
		MMA7660_DIR_Y = 1;
		MMA7660_DIR_Z = 1;
		s_ut_model = 501;
	...
	{
		printk("g_selected_utmodel d816 +_+_+\n");
		MMA7660_DIR_X = -1;
		MMA7660_DIR_Y = -1;
		MMA7660_DIR_Z = -1;
		s_ut_model = 816;
	...
	else	if(strncmp(g_selected_utmodel, "d108", strlen("d108")) == 0)
	{
		printk("g_selected_utmodel d816 +_+_+\n");
		MMA7660_DIR_X = -1;
		MMA7660_DIR_Y = 1;
	...
	{
		printk("g_selected_utmodel d720 +_+_+\n");
		MMA7660_DIR_X = -1;
		MMA7660_DIR_Y = 1;
		MMA7660_DIR_Z = -1;
	...
	{
		printk("g_selected_utmodel s106 +_+_+\n");
		s_ut_model=106;
		MMA7660_DIR_X = 1;
		MMA7660_DIR_Y = -1;
		MMA7660_DIR_Z = -1;
	...
	{
		printk("g_selected_utmodel d521 +_+_+\n");
		s_ut_model=521;
		MMA7660_DIR_X = -1;
		MMA7660_DIR_Y = 1;
		MMA7660_DIR_Z = -1;
...
static int mma8452_poll_thread(void * data)
{
	...
	while(1)
	{
		...
		{
			if (702==s_ut_model){
				s_x = x = mma7660_i2c_read(3) / 2;
				s_y = y = mma7660_i2c_read(1)/2;
				s_z = z = mma7660_i2c_read(5)/2;
			}
			else if(703==s_ut_model){
				s_x = x = abs(128 - mma7660_i2c_read(3) / 2);
				s_y = y = mma7660_i2c_read(1)/2;
				s_z = z = mma7660_i2c_read(5)/2;
			}
			else if(501==s_ut_model){
				s_x = x = mma7660_i2c_read(3) / 2;
				s_y = y = mma7660_i2c_read(1)/2;
				s_z = z = mma7660_i2c_read(5)/2;
			}

			else if(816==s_ut_model){
				s_x = x = mma7660_i2c_read(3) / 2;
				s_y = y = mma7660_i2c_read(1)/2;
				s_z = z = mma7660_i2c_read(5)/2;
			}

			else if(108==s_ut_model){
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Urbest mma7660 G-sensor");
