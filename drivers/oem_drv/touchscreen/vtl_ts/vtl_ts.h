...
/* added by Albert_lee 2014-04-23 begin */
	unsigned char	b_CtpRestPinOpposite:1;
	unsigned char	b_CtpHaveTouchKey:1;
...
struct	ts_info{
	...
	struct struct_vkeys_data 	*vkeys;
	int				vkeys_num;
	int				vkey_press;
	int				vkey_release;
