...
static unsigned char binary_data_d720[] = {
#include "dzh702044yjhtD720_CT362_01_V01_09D8_140527.dat"
};
...
//	if(model_tp_flag == 1003)
//      	  	binary_data=binary_data_s1003;
//        else if(model_tp_flag == 7001)
//		binary_data=	binary_data_s7801;
//        else if(model_tp_flag == 9001)
//		binary_data=	binary_data_s9702;
//	else if(model_tp_flag == 8001)
//		binary_data=	binary_data_s8001;
//	else

	if (816==model_tp_flag) {
		binary_data=	binary_data_d816;
	}else if(model_tp_flag==720){
