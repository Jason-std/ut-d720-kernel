...
#ifndef 	_LINUX_GOODIX_TOUCH_8027_H
#define		_LINUX_GOODIX_TOUCH_8027_H
...
#define TOUCH_MAX_HEIGHT 	4096	  //lulu		
#define TOUCH_MAX_WIDTH		4096   //lulu


#define SCREEN_MAX_HEIGHT	768
...
//#define INT_PORT  	  S5PV210_GPH1(0) // S3C64XX_GPN(15)						//Int IO port  S3C64XX_GPL(10)
#define INT_PORT 	 EXYNOS4_GPX0(4)
#define RESET_PORT	  EXYNOS4212_GPM3(4)

#ifdef INT_PORT
	#define TS_INT 		EINT_NUM//gpio_to_irq(INT_PORT)			//Interrupt Number,EINT18(119)
	#define INT_CFG    		S3C_GPIO_SFN(0x0f)//S3C_GPIO_SFN(2)					//IO configer as EINT
#else
	//#define TS_INT	0
#endif	
...
static const char *goodix_ts_name ="goodix_touch";//"Goodix Capacitive TouchScreen";

#define FT5X0X_NAME	"ft5x0x_ts"//"synaptics_i2c_rmi"//"synaptics-rmi-ts"// 
static const char *s3c_ts_name = "goodix_touch";
