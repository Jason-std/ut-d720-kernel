...
#define GTP_RST_PORT     GPIO_CTP_RST
#define GTP_INT_PORT      GPIO_CTP_INT
#define GTP_INT_IRQ         IRQ_CTP_INT// gpio_to_irq(GTP_INT_PORT)
...
// STEP_4(optional): If keys are available and reported as keys, config your key info here                             
    ...
    #define GTP_KEY_TAB  {KEY_MENU, KEY_BACK, KEY_HOME}
#endif
