...
u16 show_len;
u16 total_len;
EXPORT_SYMBOL_GPL(show_len);
EXPORT_SYMBOL_GPL(total_len);
...
EXPORT_SYMBOL_GPL(gup_enter_update_mode);
...
EXPORT_SYMBOL_GPL(gup_leave_update_mode);
...
EXPORT_SYMBOL_GPL(gup_update_proc);
