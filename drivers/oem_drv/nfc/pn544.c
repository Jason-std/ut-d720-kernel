...
//	s3c_gpio_setpull(platform_data->firm_gpio, S3C_GPIO_PULL_DOWN);
	...
	//eint16 setting
	s3c_gpio_cfgpin(platform_data->irq_gpio, 0x0f);
...
static int __init pn544_dev_init(void)
{
	...
	if(strncmp(g_selected_nfc, "nxp701", strlen("nxp701"))!=0) {
		pr_info("Loading pn544 driver, nfc_oem=[%s]\n", g_selected_nfc);
		return -1;
	}
