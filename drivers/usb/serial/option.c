...
#define BROADFONE_X9_PRODUCT_ID  0x9003 
...
static const struct usb_device_id option_ids[] = {
  { USB_DEVICE(BROADFONE_X9_VENDOR_ID, BROADFONE_X9_PRODUCT_ID) }, 

  
	{ USB_DEVICE(QUALCOMM_VENDOR_ID, 0x0016)}, /* iball 3.5G */
	{ USB_DEVICE(0x05c6, 0x0018)}, /* HSUPR 3.5G Wireless Modem*/ 
	{ USB_DEVICE(0x1c9e,0x9605)},  // ÁúÆì3åG
	{USB_DEVICE(0x0e8d,0x7118)},
	{USB_DEVICE(0x05c6,0x0015)},
	{USB_DEVICE(0x19d2,0x1203)},
	...
	{USB_DEVICE(0x0d46,0x45ad)},

	{USB_DEVICE(0x15eb,0x7152)},

	{USB_DEVICE(0x12d1,0x1444)},
	{USB_DEVICE(0x0421,0x0612)},
	{USB_DEVICE(0x21f5,0x2008)},
	{USB_DEVICE(0x0421,0x060e)},


	{USB_DEVICE(0x1ab7,0x2000)},
	{USB_DEVICE(0x1dbc,0x0005)},

	{USB_DEVICE(0x1dbc,0x0005)},
	{USB_DEVICE(0x19d2,0x0116)},
	{USB_DEVICE(0x19d2,0x0167)},
	{USB_DEVICE(0x1ee8,0x003e)},

	{USB_DEVICE(0x16d8,0x6533)},

	{USB_DEVICE(0x0421,0x0623)},
	...
	{USB_DEVICE(0x12d1,0x14a5)},
	{USB_DEVICE(0x20a6,0x1105)},

	{USB_DEVICE(0x1004,0x61a7)},
	...
	{USB_DEVICE(0x198a,0x0002)},

	{USB_DEVICE(0x106c,0x3717)},
	{USB_DEVICE(0x19f5,0x9909)},
	{USB_DEVICE(0x12d1,0x1035)},
	{USB_DEVICE(0x19d2,0x1218)},
	{USB_DEVICE(0x04cc,0x2259)},
	{USB_DEVICE(0x106c,0x3715)},
	{USB_DEVICE(0x12d1,0x1491)},
	{USB_DEVICE(0x057c,0x8401)},
	{USB_DEVICE(0x19d2,0x1003)},
	{USB_DEVICE(0x19d2,0x1015)},
	{USB_DEVICE(0x1c9e,0x6061)},
	{USB_DEVICE(0x12d1,0x14a8)},

	{USB_DEVICE(0x12d1,0x1034)},


	{USB_DEVICE(0x05c7,0x6000)},

	{USB_DEVICE(0x04e8,0x6601)},
	{USB_DEVICE(0x05c6,0x9000)},
	{USB_DEVICE(0x16d8,0x6006)},
	{USB_DEVICE(0x1ee8,0x0012)},
	{USB_DEVICE(0x0d46,0x45a9)},

	{USB_DEVICE(0x1c9e,0x9202)},
	{USB_DEVICE(0x106c,0x3716)},
	{USB_DEVICE(0x19f5,0x9905)},
	{USB_DEVICE(0x1dd6,0x1002)},
	{USB_DEVICE(0x19d2,0x1181)},
	{USB_DEVICE(0x1004,0x6114)},

	{USB_DEVICE(0x05c6,0x00a0)},
	{USB_DEVICE(0x1fe7,0x0100)},


	{USB_DEVICE(0x07d1,0x7e11)},
	{USB_DEVICE(0x028A,0x1006)},
	{USB_DEVICE(0x19d2,0xffe5)},
	{USB_DEVICE(0x20a6,0x1008)},
	{USB_DEVICE(0x19d2,0x0172)},

	{USB_DEVICE(0x04e8,0x6601)},

	{USB_DEVICE(0x07d1,0x3e02)},
	
	{USB_DEVICE(0x0471,0x1206)},
	{USB_DEVICE(0x0471,0x1234)},
	{USB_DEVICE(0x0b3c,0xc003)},
	{USB_DEVICE(0x0b3c,0xc004)},
	...
	{USB_DEVICE(0x12d1,0x1c08)},

	{USB_DEVICE(0x0b3c,0xc001)},
	{USB_DEVICE(0x0b3c,0xc002)},

	{ USB_DEVICE(0x1b7d, 0x0001)}, /* TATA Photon */
			...
			const struct usb_device_id *id)
{
	...
	if(serial->dev->descriptor.idVendor == HUAWEI_VENDOR_ID) {
		usb_enable_autosuspend(serial->dev); //  it's NC, real ???
	}
...
static void option_instat_callback(struct urb *urb)
{
	...
	if (status == 0) {
		...
		if((status==-EPIPE || status == -EPROTO) && err_times++ >10){
			err_times = 0;
