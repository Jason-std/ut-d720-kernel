...
// albert
...
#if 0//defined(CONFIG_LINK_DEVICE_HSIC) && defined(CONFIG_UMTS_MODEM_XMM6262)
	 ...
	 * portnum 3 is HSIC phy1 for CP.
	 */
	limit_timeout = (dev->portnum == 3) ? min(timeout, 2000) : timeout;

//	if(dev->portnum == 3) {
		printk("%s: dev=%s, portnum=%d, timeout=%d\n", __func__,
