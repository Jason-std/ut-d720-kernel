...
extern void lenove_s5p_dsim_enable_hs_clock(unsigned int dsim_base, unsigned char enable);
...
//new add by xufei
//from
extern unsigned int s5p_dsim_rd_rx_data(unsigned int dsim_base);
extern void s5p_dsim_force_bta(unsigned int dsim_base);
 void s5p_dsim_force_d_phy_stop_state(unsigned int dsim_base, u8 ucEn);
extern unsigned int s5p_dsim_get_intr_state(unsigned int dsim_base);
