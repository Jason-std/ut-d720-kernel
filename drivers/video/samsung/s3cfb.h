...
/* IOCTL commands */
#ifndef S3CFB_WIN_POSITION
#define S3CFB_WIN_POSITION		_IOW('F', 203, \
						struct s3cfb_user_window)
#endif

#ifndef S3CFB_WIN_SET_PLANE_ALPHA
#define S3CFB_WIN_SET_PLANE_ALPHA	_IOW('F', 204, \
						struct s3cfb_user_plane_alpha)
#endif

#ifndef S3CFB_WIN_SET_CHROMA
...
extern int s3cfb_set_clock_down(struct s3cfb_global *ctrl,unsigned long mode);
...
extern int s6e8aa0_early_suspend(void);
extern int s6e8aa0_late_resume(void);
...
/* LCD */
extern void s3cfb_set_lcd_info(struct s3cfb_global *ctrl);
extern void write_colorgain_reg(void);
extern void dp501_train_init(void);
#endif /* _S3CFB_H */
//----------------------------------------------------------
//----------------------------------------------------------
//# define machine_is_cyit_dvt()  (machine_arch_type == MACH_TYPE_CYIT_DVT)
...
//#define ESD_FOR_LCD   (machine_is_cyit_dvt())
