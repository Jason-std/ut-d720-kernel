...
static long mmc3416x_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case MMC3416X_IOC_READ:
        ...
        case MMC3416X_COVER_DATA:
		copy_from_user(ypr, pa, sizeof(ypr));
		//printk("set[4]=%d--[5]=%d---[6]=%d--\n",ypr[4],ypr[5],ypr[6]);
		//printk("set[4]=%d--[5]=%d---[6]=%d--\n",ypr[7],ypr[8],ypr[9]);	
		break;
        case  MMC_GET_COVER_VAL :
                copy_to_user(pa, ypr, sizeof(ypr));
		///printk("get[4]=%d--[5]=%d---[6]=%d--\n",ypr[4],ypr[5],ypr[6]);
		//printk("get[4]=%d--[5]=%d---[6]=%d--\n",ypr[7],ypr[8],ypr[9]);			
               break;
